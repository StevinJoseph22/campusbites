...
CREATE TABLE "MenuItem" (
    ...
    "takeawayCharge" REAL NOT NULL DEFAULT 10,
...
CREATE TABLE "OrderItem" (
    ...
    CONSTRAINT "OrderItem_stallId_fkey" FOREIGN KEY ("stallId") REFERENCES "Restaurant" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "SystemSetting" (
    ...
    "takeawayFee" REAL NOT NULL DEFAULT 10.0
);
